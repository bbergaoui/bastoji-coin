...
"""Verify that starting bastoji with -h works as expected."""

from test_framework.test_framework import BastojiTestFramework
from test_framework.util import assert_equal

class HelpTest(BastojiTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bastoji with -h for help text")
        ...
        self.log.info("Start bastoji with -version for version information")
        ...
        self.log.info("Start bastojid with -fakearg to make sure it does not start")
