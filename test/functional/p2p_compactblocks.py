...
# TestP2PConn: A peer we use to send messages to bastojid, and store responses.
...
class CompactBlocksTest(BastojiTestFramework):
    ...
    # This test actually causes bastojid to (reasonably!) disconnect us, so do this last.
    ...
    # Test that bastojid requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for bastojid to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # bastojid will not send blocktxn responses for blocks whose height is
