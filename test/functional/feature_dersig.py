...
class BIP66Test(BastojiTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bastojid is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bastojid produces more specific reject
            # reasons.
