...
* sqoin.conf: contains configuration settings for sqoind or sqoin-qt
* sqoind.pid: stores the process id of sqoind while running
...
* debug.log: contains debug information and general logging generated by sqoind or sqoin-qt
