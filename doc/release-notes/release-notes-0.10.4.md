Sqoin Core version 0.10.4 is now available from:

  <https://sqoin.org/bin/sqoin-core-0.10.4/>
...
- #6953 `43c2789` Split sqoin-tx into its own package
- #6953 `dfe0d4d` Include sqoin-tx binary on Debian/Ubuntu
