Sqoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/sqoin/files/Sqoin/sqoin-0.5.4/
...
http://gitorious.org/sqoin/sqoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Sqoin-Qt notifications under Growl 1.3.
Increase required age of Sqoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSqoin properly when installing Sqoin-Qt over it. (Windows)
