Sqoin Core version 0.9.4 is now available from:

  https://sqoin.org/bin/0.9.4/
...
this update is incompatible with the Sqoin system and could lead to consensus
forks.

Sqoin Core released binaries from https://sqoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~sqoin/+archive/ubuntu/sqoin
- A third-party or self-compiled Sqoin Core

upgrade to Sqoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
