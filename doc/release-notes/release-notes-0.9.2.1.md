Sqoin Core version 0.9.2.1 is now available from:

  https://sqoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BTJ to 0.01 BTJ
...
- Fix "Start sqoin on system login"
