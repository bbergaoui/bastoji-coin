Sqoin Core version 0.16.1 is now available from:

  <https://sqoin.us/bin/sqoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting sqoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure sqoind processes are cleaned up when tests end (sdaftuar)
