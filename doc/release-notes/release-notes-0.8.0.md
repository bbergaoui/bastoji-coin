Sqoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/sqoin/files/Sqoin/sqoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Sqoin
...
New/changed settings (command-line or sqoin.conf file)
--------------------------------------------------------
