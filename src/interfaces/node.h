...
#ifndef BASTOJI_INTERFACES_NODE_H
#define BASTOJI_INTERFACES_NODE_H
...
//! Top-level interface for a bastoji node (bastojid process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BASTOJI_INTERFACES_NODE_H
