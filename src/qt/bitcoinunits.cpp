...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTJ: return QString("Bitcoins");
    case mBTJ: return QString("Milli-Bitcoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTJ: return QString("Micro-Bitcoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
