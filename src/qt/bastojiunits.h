...
#ifndef BASTOJI_QT_BASTOJIUNITS_H
#define BASTOJI_QT_BASTOJIUNITS_H
...
*/
class BastojiUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BastojiUnits(QObject *parent);

    /** Bastoji units.
      @note Source: https://en.bastoji.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTJ,
...
typedef BastojiUnits::Unit BastojiUnit;

#endif // BASTOJI_QT_BASTOJIUNITS_H
