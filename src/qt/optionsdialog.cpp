    ...
    mapper(0)
{
    ...
    ui->bastojiAtStartup->setToolTip(ui->bastojiAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bastojiAtStartup->setText(ui->bastojiAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openBastojiConfButton->setToolTip(ui->openBastojiConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BastojiUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bastojiAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBastojiConfButton_clicked()
{
