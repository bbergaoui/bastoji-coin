...
static void SetupBastojiTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bastoji-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bastoji-tx [options] <hex-tx> [commands]  Update hex-encoded bastoji transaction\n" +
            "or:     bastoji-tx [options] -create [commands]   Create hex-encoded bastoji transaction\n" +
            "\n";
