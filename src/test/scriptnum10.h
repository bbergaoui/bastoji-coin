...
#ifndef BASTOJI_TEST_SCRIPTNUM10_H
#define BASTOJI_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bastoji Core 0.10.0, for cross-comparison.
 */
public:
