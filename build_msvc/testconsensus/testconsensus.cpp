...
// bastoji includes.
#include <..\src\script\bastojiconsensus.h>
...
int main()
{
    std::cout << "bastojiconsensus version: " << bastojiconsensus_version() << std::endl;
    ...
    auto op0Result = bastojiconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, bastojiconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
